  ...
  <table class="flat-table" width="100%" border="1" cellspacing="2" rules="rows">
	...
	?>
	 <tr>
      ...
      <td align="center"><?php echo $row[1].' '.$row[2];?></td>
      ...
      <td align="center"><img src="profile_upload/<?php echo $row[15];?>" height="30px" width="30px"> </td>
	  <!--<td align="center"><img src="id_upload/<?php /*echo $row->id;*/?>" height="50px" width="50px"> </td>-->
      <td cellspacing="3" align="center"><a href="user_list.php?accept_id=<?php echo $row[9];?>"><img src="web\images\accept.png" height="30" width"50"/></a></td>
	  <td cellspacing="3" align="center"><a href="user_list.php?delete_id=<?php echo $row[9];?>"><img src="web\images\delete.png" height="30" width"50"/></a></td>
	</tr>
    <?php }
	 ?>
  </table>
